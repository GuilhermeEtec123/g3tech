                        ...
                        <a href="{{ route('project', ['id' => $projeto->id]) }}">
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    @if (Auth::user()->clientType == 2)
                                        <form
                                            action="{{ route('team-join-requests.store', ['projetoId' => $projeto->id]) }}"
                                            method="post">
                                            @csrf
                                            @method('post')
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1 align-items-center">
                                                    <div class="text-center">
                                                        ...
                                                        <h6 class="text-sm mb-0">{{ $projeto->created_at->format('d/m/Y') }}
                                                        </h6>
                                            ...
                                            <td class="col text-center fs-5 d-flex flex-column">
                                                <div class="d-flex px-2 py-1 align-items-center flex-column">
                                                    ...
                                                    <div class="d-flex flex-row">
                                                        ...
                                                        <h6 class="text-sm mb-0 ms-2 text-cente ">
                                                            {{ $projeto->qtdPrestadores }}</h6>
                                                    </div>
