        ...
        <section>
            <div class="page-header min-vh-100">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Coloque seu email e senha para fazer o login</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="rememberMe">Me lembrar</label>
                                        </div>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        Não tem uma conta? 
                                        <a href="{{ route('register') }}" class="text-primary text-gradient font-weight-bold">Inscreva-se</a>
                                    </p>
                                </div>
                            </div>
                        </div>
              ...
              background-size: cover;">
                                ...
                                <p class="text-white position-relative">Quanto mais fácil parecer a escrita, maior o
                                    esforço que o escritor realmente colocou no processo.
                                </p>
                            </div>
                        </div>
                    </div>
